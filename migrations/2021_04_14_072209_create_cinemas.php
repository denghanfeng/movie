...
class CreateCinemas extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('cinemas', function (Blueprint $table) {
            ...
            $table->string('cinemaName',100)->nullable()->default('')->comment('影院名称');
            $table->string('address')->nullable()->default('')->comment('影院地址');
            $table->double('latitude',9,5)->nullable()->default(0)->comment('纬度');
            $table->double('longitude',9,5)->nullable()->default(0)->comment('经度');
            $table->string('phone',50)->nullable()->default('')->comment('影院电话');
